...
docs:
	...
	@echo "  docs/deployment.md             - Daemon + OpenVPN server deployment"
	@echo "  docs/keycloak.md               - Keycloak configuration and troubleshooting"
	@echo "  docs/client-setup.md           - Client setup guide"
	@echo "  docs/architecture.md           - Architecture and auth flow"
	@echo "  docs/security.md               - Security model and checklist"
